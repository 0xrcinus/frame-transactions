...
The simplifications proposed on Ethereum Magicians (two modes, no scope bits, group-based atomicity) would have eliminated real implementation complexity in our SDK.
